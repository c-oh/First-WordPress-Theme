 ...
 * @author    Holly <papiniu@outlook.com>
 * @license   GPL-2.0+
 * @link      http://www.redacademy.com
 * @copyright 2016 Holly
 *
 * @wordpress-plugin
 * Plugin Name:       Business Hours Widget
 * Plugin URI:        http://www.redacademy.com
 * Description:       A custom business hours widget plug in.
 * Version:           1.0.0
 * Author:            Holly
...
class Biz_Hours_Widget extends WP_Widget {
    ...
    /**
     * @TODO - Rename "biz-hours-widget" to the name your your widget
     *
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'Set the hours of your business here'
			)
		);
